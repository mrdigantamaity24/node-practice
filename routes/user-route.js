...
routers.patch('/:id', authController.protectRoutes, userController.updateUserData);   // update user data
...
routers.patch('/updatepassword/:id', authController.protectRoutes, authController.passwordUpdate); // signup route
